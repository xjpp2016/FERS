...
from utils.utils import  print_log, seed_torch,write_eval_result,write_name, get_admap
...
def main():
    ...
    # test
    test_imgs, mixfs, scores, gt_imgs, total_time = test(args, convh, encoder, classifier, spa_fen, test_loader)
...
def test(args, convh, encoder, classifier, spa_fen, test_loader):
    ...
    for (data, gt) in tqdm(test_loader):
        ...
        with torch.no_grad():
            ...
            output, spe_f = classifier(encoder(convh(data)), data)
